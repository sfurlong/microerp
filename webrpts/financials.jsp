...
<% 
    ...
    sqlStmt = " select rpts.id, rpt_name, rpt_url, has_read_access " +
                     ...
                     " where sec.userid = '" + userId + "' and tab_id = 'FINANCIAL' and " +
...
<center>
<TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0 bgcolor="#cc99ff">
...
<tr bgcolor=#ffffff>
	<img src="images/tab.gif" align=absBottom usemap="#map" border="0">
</tr>
<tr>
	<td><br>
