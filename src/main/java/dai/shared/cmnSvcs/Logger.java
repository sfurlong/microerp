...
public class Logger
{
	...
	public void trace(int traceLevel, String className, String methodName, String msg)
	{
        if (_traceLevel < traceLevel) return;
...
/////////////////  Private Methods/Data //////////////////////////
    ...
    private Logger() {
        ...
        _traceLevel = _sessionMeta.getTraceLevel();
    	}catch (Exception e) {
    		//nothing to do.
    	}
    }
    ...
    private SessionMetaData _sessionMeta = null;
