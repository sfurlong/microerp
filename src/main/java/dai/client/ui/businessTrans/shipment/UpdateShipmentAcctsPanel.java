...
public class UpdateShipmentAcctsPanel extends daiWizardPanel
{
	...
	daiLabel daiLabel_shippingAcct = new daiLabel("Deposit Account:");

    boolean firstTimeThrough = false;
    daiLabel daiLabel_taxAcct = new daiLabel();
    daiTextField daiTextField_taxAcctId = new daiTextField();
    daiTextField daiTextField_taxAcctName = new daiTextField();

    public UpdateShipmentAcctsPanel()
    {
        try
        {
            jbInit();
    ...
    private void jbInit() throws Exception
    {
	    ...
	    daiTextField_taxAcctId.setDisabled(true);
	    daiTextField_taxAcctName.setDisabled(true);
        ...
        daiLabel_shippingAcct.setHREFstyle(true);
        daiLabel_shippingAcct.setText("Shipping(Out) Account:");
        daiLabel_shippingAcct.adddaiActionListener(new daiActionListener() {
            public void daiActionEvent(daiActionEvent e) {
                daiLabel_shippingAcct_daiAction(e);
            }
        });
        daiLabel_taxAcct.setHREFstyle(true);
        daiLabel_taxAcct.setText("Tax Account:");
        daiLabel_taxAcct.adddaiActionListener(new daiActionListener() {
            public void daiActionEvent(daiActionEvent e) {
                daiLabel_taxAcct_daiAction(e);
            }
        });
        ...
        this.add(fieldControl_shipAcctName, new XYConstraints(299, 117, 251, -1));
        this.add(daiLabel_acctsReceivableId, new XYConstraints(51, 70, -1, -1));
        this.add(daiTextField_taxAcctId, new XYConstraints(164, 164, 132, -1));
        this.add(daiTextField_taxAcctName, new XYConstraints(299, 164, 251, -1));
        this.add(daiLabel_taxAcct, new XYConstraints(92, 166, -1, -1));
        this.add(fieldControl_shipAcctId, new XYConstraints(164, 117, 132, -1));
        this.add(daiLabel_shippingAcct, new XYConstraints(44, 120, -1, -1));
    }

    public boolean panelDataIsValid()
    {
        if (fieldControl_acctsReceivableId == null || fieldControl_shipAcctId == null) {
    ...
    public default_accountsObj getDefaultAccountObj()
    {
        ...
        _defaultAcctsObj.set_undeposited_funds_id(fieldControl_shipAcctId.getText());
        _defaultAcctsObj.set_undeposited_funds_name(fieldControl_shipAcctName.getText());
    ...
    public String getShippingAcctId() {
        String ret = fieldControl_shipAcctId.getText();
        return ret;
    }

    public String getTaxAcctId() {
        String ret = daiTextField_taxAcctId.getText();
        return ret;
    }
    ...
    private void getDefaultAccountData()
    {
        ...
        try {
		    ...
		    fieldControl_shipAcctId.setText(_defaultAcctsObj.get_shipping_out_id());
    		fieldControl_shipAcctName.setText(_defaultAcctsObj.get_shipping_out_name());
		    daiTextField_taxAcctId.setText(_defaultAcctsObj.get_sales_tax_payable_id());
    		daiTextField_taxAcctName.setText(_defaultAcctsObj.get_sales_tax_payable_name());
        } catch (Exception e) {
			e.printStackTrace();
    ...
    void daiLabel_shippingAcct_daiAction(daiActionEvent e) {
    ...
    void daiLabel_taxAcct_daiAction(daiActionEvent e) {
        ...
        accountObj chosenObj = (accountObj)chooser.getChosenObj();
        if (chosenObj != null) {
            daiTextField_taxAcctId.setText(chosenObj.get_id());
            daiTextField_taxAcctName.setText(chosenObj.get_description());
        }
    	chooser.dispose();
    }
}
