...
public class QueryApp
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			{
				String PATH = "c:/altaprise/cooper/rpt/jasper/";
				JasperCompileManager.compileReportToFile(PATH+fileName+".jrxml");
				System.err.println("Compile time : " + (System.currentTimeMillis() - start));

				//Preparing parameters
				Map parameters = new HashMap();
				parameters.put("shipmnet_id", "Address Report");
				
				if (TASK_FILL_IGNORE_PAGINATION.equals(taskName))
				{
					parameters.put(JRParameter.IS_IGNORE_PAGINATION, Boolean.TRUE);
				}
				JasperFillManager.fillReportToFile(PATH+fileName+".jasper", parameters, getConnection());
				System.err.println("Filling time : " + (System.currentTimeMillis() - start));

				net.sf.jasperreports.view.JasperViewer.viewReport(PATH+fileName+".jrprint", false);
