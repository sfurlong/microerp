...
public class prospect_journalObj extends BusinessObject
{
	...
	//STATIC DATA //
	static public final String TABLE_NAME = "PROSPECT_JOURNAL";
	static public final String ID = "PROSPECT_JOURNAL.ID";
	static public final String LOCALITY = "PROSPECT_JOURNAL.LOCALITY";
	static public final String DETAIL_ID = "PROSPECT_JOURNAL.DETAIL_ID";
	static public final String CREATED_BY = "PROSPECT_JOURNAL.CREATED_BY";
	static public final String DATE_CREATED = "PROSPECT_JOURNAL.DATE_CREATED";
	static public final String SUBJECT = "PROSPECT_JOURNAL.SUBJECT";
	static public final String NOTE = "PROSPECT_JOURNAL.NOTE";
	static public final String PRIORITY = "PROSPECT_JOURNAL.PRIORITY";
	static public final String USER1 = "PROSPECT_JOURNAL.USER1";
	static public final String USER2 = "PROSPECT_JOURNAL.USER2";
	static public final String USER3 = "PROSPECT_JOURNAL.USER3";
	static public final String USER4 = "PROSPECT_JOURNAL.USER4";


	//Constructor
	public prospect_journalObj()
	{
		//Private Field Members.
		MAX_COLS = 12;
		TAB_NAME = "PROSPECT_JOURNAL";
	...
	{
		return new prospect_journalObj();
	}
