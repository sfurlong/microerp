...
public class shipment_itemObj extends BusinessObject
{
	...
	//STATIC DATA //
	static public final String TABLE_NAME = "SHIPMENT_ITEM";
	static public final String ID = "SHIPMENT_ITEM.ID";
	static public final String LOCALITY = "SHIPMENT_ITEM.LOCALITY";
	static public final String DETAIL_ID = "SHIPMENT_ITEM.DETAIL_ID";
	static public final String DATE_CREATED = "SHIPMENT_ITEM.DATE_CREATED";
	static public final String ITEM_ID = "SHIPMENT_ITEM.ITEM_ID";
	static public final String DESCRIPTION1 = "SHIPMENT_ITEM.DESCRIPTION1";
	static public final String DESCRIPTION2 = "SHIPMENT_ITEM.DESCRIPTION2";
	static public final String ECCN = "SHIPMENT_ITEM.ECCN";
	static public final String HTS = "SHIPMENT_ITEM.HTS";
	static public final String IS_HAZMAT = "SHIPMENT_ITEM.IS_HAZMAT";
	static public final String HAZMAT_DESCRIPT = "SHIPMENT_ITEM.HAZMAT_DESCRIPT";
	static public final String QTY_ORDERED = "SHIPMENT_ITEM.QTY_ORDERED";
	static public final String QTY_AVAIL = "SHIPMENT_ITEM.QTY_AVAIL";
	static public final String QTY_SHIPPED = "SHIPMENT_ITEM.QTY_SHIPPED";
	static public final String QTY_BACKORDER = "SHIPMENT_ITEM.QTY_BACKORDER";
	static public final String UNIT_PRICE = "SHIPMENT_ITEM.UNIT_PRICE";
	static public final String EXTENDED_PRICE = "SHIPMENT_ITEM.EXTENDED_PRICE";
	static public final String QTY_INVENTORY_POSTED = "SHIPMENT_ITEM.QTY_INVENTORY_POSTED";
	static public final String NOTE1 = "SHIPMENT_ITEM.NOTE1";
	static public final String NOTE2 = "SHIPMENT_ITEM.NOTE2";
	static public final String IS_EXTERNAL_REPAIR = "SHIPMENT_ITEM.IS_EXTERNAL_REPAIR";
	static public final String IS_INTERNAL_REPAIR = "SHIPMENT_ITEM.IS_INTERNAL_REPAIR";
	static public final String ACCOUNT_ID = "SHIPMENT_ITEM.ACCOUNT_ID";
	static public final String ACCOUNT_NAME = "SHIPMENT_ITEM.ACCOUNT_NAME";
	static public final String OUTSIDE_REPAIR_COST = "SHIPMENT_ITEM.OUTSIDE_REPAIR_COST";
	static public final String ORDER_ITEM_DETAIL_ID = "SHIPMENT_ITEM.ORDER_ITEM_DETAIL_ID";


	//Constructor
	public shipment_itemObj()
	{
		//Private Field Members.
		MAX_COLS = 26;
		TAB_NAME = "SHIPMENT_ITEM";
	...
	public void Init() {
		...
		m_dbAttribs[20] = new DBAttributes("IS_EXTERNAL_REPAIR", null, "CHAR", 1 ,true);
		m_dbAttribs[21] = new DBAttributes("IS_INTERNAL_REPAIR", null, "CHAR", 1 ,true);
		...
		m_dbAttribs[24] = new DBAttributes("OUTSIDE_REPAIR_COST", null, "NUMERIC", 0 ,true);
		m_dbAttribs[25] = new DBAttributes("ORDER_ITEM_DETAIL_ID", null, "INTEGER", 10 ,true);
	}
	...
	public String get_is_external_repair() {return m_dbAttribs[20].getValue();}
	public String get_is_internal_repair() {return m_dbAttribs[21].getValue();}
	public String get_account_id() {return m_dbAttribs[22].getValue();}
	public String get_account_name() {return m_dbAttribs[23].getValue();}
	public String get_outside_repair_cost() {return m_dbAttribs[24].getValue();}
	public String get_order_item_detail_id() {return m_dbAttribs[25].getValue();}
	...
	public void set_order_item_detail_id(String val)
	{
		if (val == null || val.length() == 0)
