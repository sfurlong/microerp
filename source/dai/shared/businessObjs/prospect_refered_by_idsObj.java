...
public class prospect_refered_by_idsObj extends BusinessObject
{
	...
	//STATIC DATA //
	static public final String TABLE_NAME = "PROSPECT_REFERED_BY_IDS";
	static public final String ID = "PROSPECT_REFERED_BY_IDS.ID";
	static public final String LOCALITY = "PROSPECT_REFERED_BY_IDS.LOCALITY";
	static public final String DATE_CREATED = "PROSPECT_REFERED_BY_IDS.DATE_CREATED";
	static public final String CREATED_BY = "PROSPECT_REFERED_BY_IDS.CREATED_BY";


	//Constructor
	public prospect_refered_by_idsObj()
	{
		//Private Field Members.
		MAX_COLS = 4;
		TAB_NAME = "PROSPECT_REFERED_BY_IDS";
	...
	{
		return new prospect_refered_by_idsObj();
	}
