...
public class state_provinceObj extends BusinessObject
{
	//!!!!!!BEGIN USER SECTION!!!!!!!
	...
	//Constructor
	public state_provinceObj()
	{
		//Private Field Members.
		MAX_COLS = 12;
		m_dbAttribs = new DBAttributes[MAX_COLS];
		TAB_NAME = "STATE_PROVINCE";
		Init();
		setDefaults();
	}
	...
	public void Init() {
		...
		m_dbAttribs[5] = new DBAttributes("SALES_TAX", null, "NUMERIC", true);
		m_dbAttribs[6] = new DBAttributes("NOTE", null, "VARCHAR", true);
		m_dbAttribs[7] = new DBAttributes("USER1", null, "VARCHAR", true);
		m_dbAttribs[8] = new DBAttributes("USER2", null, "VARCHAR", true);
		m_dbAttribs[9] = new DBAttributes("USER3", null, "VARCHAR", true);
		m_dbAttribs[10] = new DBAttributes("USER4", null, "DATE", true);
		m_dbAttribs[11] = new DBAttributes("USER5", null, "DATE", true);
	}
	...
	public String get_sales_tax() {return m_dbAttribs[5].getValue();}
	...
	public void set_sales_tax(String val)
	{
		if (val == null || val.length() == 0)
