...
public class CreateShipmentAcctsPanel extends daiWizardPanel
{
    ...
    public CreateShipmentAcctsPanel()
    {
        try
        {
            jbInit();
    ...
    public default_accountsObj getDefaultAccountObj()
    {
        ...
        _defaultAcctsObj.set_sales_tax_payable_id(fieldControl_salesTaxId.getText());
        _defaultAcctsObj.set_sales_tax_payable_name(fieldControl_salesTaxName.getText());
        _defaultAcctsObj.set_shipping_out_id(fieldControl_shippingId.getText());
        _defaultAcctsObj.set_shipping_out_name(fieldControl_shippingName.getText());
