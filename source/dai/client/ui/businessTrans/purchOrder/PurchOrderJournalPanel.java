...
public class PurchOrderJournalPanel extends daiJournalPanel
{
	public PurchOrderJournalPanel(JFrame container, daiFrame parentFrame, purch_order_journalObj obj)
	{
    ...
    {
        purch_order_journalObj obj = new purch_order_journalObj();
        purch_order_journalObj tempObj = (purch_order_journalObj)BUSINESS_OBJ;
	...
	{
		purch_order_journalObj itemObj;
		...
		{
			itemObj = (purch_order_journalObj)objVect.elementAt(i);
			GRID.addRow();
	...
	{
		purch_order_journalObj tempObj;

		//Refresh the all rows of the grid from the Item Vector.
		for (int i=0; i < GRID.getRowCount(); i++)
		{
			tempObj = (purch_order_journalObj)GRID.get(i, OBJ_COL_POS);
