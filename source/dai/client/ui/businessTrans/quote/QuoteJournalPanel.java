...
public class QuoteJournalPanel extends daiJournalPanel
{

	public QuoteJournalPanel(JFrame container, daiFrame parentFrame, quote_journalObj obj)
	{
    ...
    {
        quote_journalObj obj = new quote_journalObj();
        quote_journalObj tempObj = (quote_journalObj)BUSINESS_OBJ;
	...
	protected void updateGridFromBusinessObj(Vector objVect)
	{
		...
		{
			itemObj = (quote_journalObj)objVect.elementAt(i);
			GRID.addRow();
	...
	{
		quote_journalObj tempObj;

		//Refresh the all rows of the grid from the Item Vector.
		for (int i=0; i < GRID.getRowCount(); i++)
		{
			tempObj = (quote_journalObj)GRID.get(i, OBJ_COL_POS);
