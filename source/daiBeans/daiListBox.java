...
public class daiListBox extends JPanel
{
    ...
    {
        if(daiListBoxItemSelectedListeners != null && daiListBoxItemSelectedListeners.contains(l))
        {
    ...
    {
        Vector v = daiListBoxItemSelectedListeners == null ? new Vector(2) : (Vector) daiListBoxItemSelectedListeners.clone();
        if(!v.contains(l))
        {
            v.addElement(l);
            daiListBoxItemSelectedListeners = v;
