...
rem       DAI_HOME      Root of the development environment (ie. d:\release\v71)
rem
...
if "%DAI_HOME%"=="" goto badvar


echo %CLASSPATH%

call ant -Ddebug="on" -Djdk.home=%JAVA_HOME% -Dbuild.root.dir=%DAI_HOME% -buildfile %DAI_HOME%\build.xml %1 %2 %3 %4 
goto end
